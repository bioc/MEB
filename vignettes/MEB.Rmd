...
sim_model_sp <- MEB(countsTable=assay(sim_data_sp), train_id=1:1000, gamma,
...
sim_model_dsp <- MEB(countsTable=assay(sim_data_dsp), train_id=1:1000, gamma,
...
real_model_dsp <- MEB(countsTable=assay(real_data_dsp), train_id=1:143, gamma,
nu = 0.01, reject_rate = 0.1, ds = TRUE)
```
