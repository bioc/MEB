...
#' @description Use the Minimum Enclosing Ball (MEB) method to discriminate
#' differential expression (DE) genes in the same or different species.
#' @usage MEB(countsTable, train_id, gamma, nu = 0.01, reject_rate = 0.1,
#' ds = FALSE)
...
#' different species.
#' @return list(.) A list of results, "model" represents the model of MEB,
#' which could be used to discriminate a new gene, "gamma" represents the
#' selected gamma parameters in model MEB, "train_error" represents the
